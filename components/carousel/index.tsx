        ...
        {slides.map((slide) => {
          return (
            ...
            >
              ...
              />
              <span className="font-serif text-2xl mb-2">{slide.name}</span>
              <span className="text-[#A5A6A7] text-[18px] text-center">
                {slide.text}
              </span>
            </div>
          );
...
function Arrow(props: {
  ...
  return (
    <div
      className="group h-10 w-10 rounded-full border grid place-items-center hover:bg-[#434343] transition border-[#434343]"
      onClick={props.onClick}
    >
      <svg
        className={`arrow w-6 h-6 group-hover:fill-white ${
